...
export function generateEmail(form) {
  ...
  body += ".\n";
  if (showCount > 1) body += "\n" + showLines.join("\n") + "\n";
  body += "\nThe total for this offer is " + formatCurrency(total) + " (GST excl). The attached rate card is a simple costs sheet setting out exactly what you can invoice for this booking, including any travel days and per diems.\n";
  body += "\nPlease respond in writing with \"Yes\" to confirm your availability and acceptance of the offer.\n";
  body += "\nInvoices that match this offer are paid within 14 days of the invoice date.\n";
